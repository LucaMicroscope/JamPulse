...
// - nella colonna di destra troviamo l'autore, la descrizione, i commenti e l'input per aggiungere nuovo contenuto.
export default function PostDetail() {
    return (
        ...
        >
            ...
            <Stack sx={{ alignItems: 'start', justifyContent:'space-between' }}>
