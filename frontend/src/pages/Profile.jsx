...
export default function Profile() {
    return (
        // Stack principale orizzontale: raggruppa la sidebar e il contenuto della pagina.
        // Ho usato uno Stack in riga perché la pagina è composta da due blocchi distinti:
        // una colonna laterale di navigazione e una sezione centrale dedicata al profilo.
        <Stack direction='row'>            
            <Sidebar />
